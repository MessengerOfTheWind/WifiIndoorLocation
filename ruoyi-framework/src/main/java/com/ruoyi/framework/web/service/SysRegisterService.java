...
public class SysRegisterService
{
     ...
     * 注册
     */
    public String userRegister(RegisterBody registerBody)
    {
        String msg = "", username = registerBody.getUsername(), password = registerBody.getPassword();
        SysUser sysUser = new SysUser();
        sysUser.setUserName(username);
        ...
        if (captchaEnabled)
        {
            validatePhoneCaptcha(username, registerBody.getCode(), registerBody.getUuid());
        }
        ...
        {
            sysUser.setNickName(new GenerateNickNameUtils().generateUsername());
     ...
     * @return 结果
     */
    public void validatePhoneCaptcha(String username, String code, String uuid)
    {
